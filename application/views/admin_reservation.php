...
<div class="panel panel-default" id="adminManageReservation">
    ...
    <div class="panel-body">
            ...
            <div class="panel panel-default" id="addOrEditReservation">
                ...
                <div id="collapseOne" class="panel-collapse collapse">
                    <div class="alert alert-info alert-dismissable" style="display:none;">
                        <button type="button" class="close" data-hide="alert" aria-hidden="true">&times;</button>
                        <strong>Advertencia!</strong> Debe llenar todos los campos.
                    </div>
                    <div class="panel-body clearfix">
                        <form action="#" method="POST" id="addReservationAdmin">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <label class="col-sm-6 control-label">Nombre doctor:</label>
                                                ...
                                                <div class="col-md-6">
                                                    <label class="col-sm-6 control-label">Nombre Paciente:</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                        ...
                                        <div class="panel-body" style="padding: 5px 15px;">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="col-sm-12 control-label">Servicio:</label>
                                                    <div class="col-sm-12">
                                                        <div class="bs-component">
                                                            <select class="select2-aux select2-offscreen" name="adminServicesReservation">
                                                                <?php
                                            ...
                                            <h5>Nombre de la Macota: <span class="petNameUser"></span></h5>
                                    ...
                                    <button type="button"  class="btn btn-success pull-right submitReservation" style="margin-top:10px;    margin-left: 2em;">Agregar </button>
                                    <button type="reset"  class="btn btn-default pull-right"  id="closeForm" style="margin-top:10px;">Cancelar</button>
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        <div class="input-group">
            ...
            <input type="text" class="form-control adminSearchReservationText" placeholder="Ingrese el email de usuario">
        </div>
    </div>
