                    ...
                    <div id="collapseOne" class="panel-collapse collapse">
                        ...
                        <div class="panel-body clearfix">
                            <form action="addProduct" method="POST" id="addProduct">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="bs-component">
                                                    <input type="number" style="width:250px;" class="form-control" name="productQty" id="productQty" placeholder="Cantidad" min="1" required  onkeypress="return numeros(event)">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="bs-component">
                                                    <input type="number" style="width:250px;" class="form-control" name="productPrice" id="productPrice" placeholder="Precio" min="1" required  onkeypress="return numeros(event)">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="bs-component">
                                                    <select class="form-control" name="productType" id="productType" >
                                                        <option value="Tabletas y Capsulas">Tabletas y Capsulas</option>
                                ...
                                <button type="submit" class="btn btn-sm btn-info" style="float:right;margin-top:10px;" id="addproduct">Guardar</button>
                            </form>
